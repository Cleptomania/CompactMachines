...
public class CompactMachines {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (ConfigurationHandler.dimensionId != -1) {
            if (event.getSide() == Side.SERVER) {
                ...
                DimensionManager
                    .registerProviderType(ConfigurationHandler.dimensionId, WorldProviderMachines.class, true);
                DimensionManager.registerDimension(ConfigurationHandler.dimensionId, ConfigurationHandler.dimensionId);
            }
        }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (Loader.isModLoaded("LookingGlass")) {
            FMLInterModComms.sendMessage(
                "LookingGlass",
                "API",
                "org.dave.CompactMachines.thirdparty.lookingglass.LookingGlassIntegration.register");
        } else {
        ...
        if (Loader.isModLoaded("Waila")) {
            FMLInterModComms.sendMessage(
                "Waila",
                "register",
                "org.dave.CompactMachines.handler.waila.BlockHandler.callbackRegister");
        }
    }
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        Reference.upgradeItem = GameData.getItemRegistry()
            .getObject(ConfigurationHandler.upgradeItem);
